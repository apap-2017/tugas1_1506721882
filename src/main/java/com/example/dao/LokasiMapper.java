...
public interface LokasiMapper {
	@Select("select a.nama_kelurahan, b.nama_kecamatan, c.nama_kota from kelurahan a, kecamatan b, kota c where "
			+ "a.id = #{id_kelurahan} AND a.id_kecamatan = b.id AND b.id_kota = c.id ")
